...
export default function AuthenticatedLayout({ header, children }) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            {/* Desktop Navigation */}
            <nav className="border-b border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 hidden md:block">
                    ...
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 dark:text-gray-500 transition duration-150 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-500 focus:outline-none"
                            >
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden bg-white dark:bg-gray-800 border-b dark:border-gray-700'}>
                    <div className="space-y-1 pb-3 pt-2">
                        {navigationLinks.map((item) => (
                            <ResponsiveNavLink key={item.name} href={route(item.href)} active={route().current(item.href)}>
                                {item.name}
                            </ResponsiveNavLink>
                        ))}
                    </div>
            ...
            {/* Content */}
            <main className="px-5 lg:px-40 flex-1 pb-20 md:pb-0 text-gray-900 dark:text-gray-100">
                {children}
            </main>
